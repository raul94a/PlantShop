...
package com.raul.plantshop.domain.payments
 ...
 *  3.  Update SHIPPING_SUPPORTED_COUNTRIES to list the countries where you currently ship. If this
 * is not applicable to your app, remove the relevant bits from PaymentsUtil.java.
 *  4.  If you're integrating with your `PAYMENT_GATEWAY`, update
 ...
 *  5.  If you're using `DIRECT` integration, please edit protocol version and public key as
...
//        "CRYPTOGRAM_3DS"
     ...
     */
    val SHIPPING_SUPPORTED_COUNTRIES = listOf("US", "US")
